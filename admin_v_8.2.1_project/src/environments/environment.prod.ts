...
export const environment = {
  ...
  URL_SERVICIOS: 'https://www.rhinomaquinaria.com.mx/api',
  URL_BACKEND: 'http://api.www.rhinomaquinaria.com.mx/api/',
  URL_FROTEND: 'http://admin.www.rhinomaquinaria.com.mx/'
};
